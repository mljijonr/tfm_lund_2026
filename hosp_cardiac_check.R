#####################################################
# ROBUSTNESS CHECK
# HOSPTIALIZATIONS DATA - CARDIAC DISEASE 
#
#
# Outcome Variable — Cardiac hospitalizations
...
# Canton Lookup file
# This dataframe contains the full list of provinces and cantons
...
cardio_categories <- categories <- c(
  tolower(I00), tolower(I01), tolower(I05), tolower(I06),
  tolower(I07), tolower(I08), tolower(I09), tolower(I10),
  tolower(I11), tolower(I12), tolower(I13), tolower(I15),
  tolower(I20), tolower(I21), tolower(I22), tolower(I23),
  tolower(I24), tolower(I25), tolower(I26), tolower(I27),
  tolower(I28), tolower(I30), tolower(I31), tolower(I33),
  tolower(I34), tolower(I35), tolower(I36), tolower(I37),
  tolower(I38), tolower(I39), tolower(I40), tolower(I41),
  tolower(I42), tolower(I43), tolower(I44), tolower(I45),
  tolower(I46), tolower(I47), tolower(I48), tolower(I49),
  tolower(I50), tolower(I51), tolower(I52)
)

cardio_codes <- c(
  "I00","I01","I05","I06","I07","I08","I09","I10",
  "I11","I12","I13","I15","I20","I21","I22","I23",
  "I24","I25","I26","I27","I28","I30","I31","I33",
...
# use as.character() to ensure the variables are text
# use trimws() to remove extra spaces at the beginning and end
# extract the first 3 characters as the code
EH_2024 <- EH_2024 %>%
  mutate(
...
egresos_2024 <- EH_2024 %>%
  ...
  summarise(
    hosp_cardio   = n(),
    cardio_deaths = sum(con_egrpa %in% c(
...
# Get the cardiointestinal diseases from the cardio_categories list
...
EH_2021 <- EH_2021 %>%
  filter(causa3 %in% tolower(cardio_categories))
...
egresos_2020 <- EH_2020 %>%
  ...
  summarise(
    hosp_cardio   = n(),
    cardio_deaths = sum(con_egrpa %in% c("2", "3"),
                        na.rm = TRUE),
    hosp_out = sum(hosp_out),
    under5 = sum(under5),
    .groups = "drop"
...
egresos_cardio_panel <- bind_rows(egresos_2018,
...
# Summary Statistics
cat("\nCases by year:\n")
egresos_cardio_panel %>%
  group_by(year) %>%
  summarise(
    cantons      = n(),
    total_cases  = sum(hosp_cardio,   na.rm = TRUE),
...
# Rename
egresos_cardio_panel <- egresos_cardio_panel %>%
  rename(hosp_cardio_under5 = under5)

egresos_cardio_panel <- egresos_cardio_panel %>%
  rename(hosp_out_cardio = hosp_out)
...
# Save
fwrite(egresos_cardio_panel, "egresos_cardio_panel_2018_2024.csv")
